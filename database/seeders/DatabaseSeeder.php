...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rahim = User::create(['name' => 'Rahim Miah', 'email' => 'rahim.cst@cmpi.edu.bd', 'password' => Hash::make('rahim123'), 'department' => 'Computer Science & Technology', 'student_id' => 'CST-85 2305', 'semester' => '4th', 'session' => '2023-2024', 'phone' => '+880 1XXX-XXXXXX', 'guardian' => 'Karim Miah (Father)', 'blood_group' => 'A+', 'address' => "Cox's Bazar, Bangladesh", 'admission_date' => '2023-06-15', 'role' => 'student', 'status' => 'active']);
        $fatima = User::create(['name' => 'Fatima Khatun', 'email' => 'fatima.civil@cmpi.edu.bd', 'password' => Hash::make('fatima123'), 'department' => 'Civil Technology', 'student_id' => 'CT-64 2318', 'semester' => '4th', 'session' => '2023-2024', 'phone' => '+880 1XXX-XXXXXX', 'guardian' => 'Abdul Kader (Father)', 'blood_group' => 'B+', 'address' => "Teknaf, Cox's Bazar", 'admission_date' => '2023-06-15', 'role' => 'student', 'status' => 'active']);
        $arif = User::create(['name' => 'Arif Rahman', 'email' => 'arif.eee@cmpi.edu.bd', 'password' => Hash::make('arif123'), 'department' => 'Electrical Technology', 'student_id' => 'ET-67 2342', 'semester' => '4th', 'session' => '2023-2024', 'phone' => '+880 1XXX-XXXXXX', 'guardian' => 'Hasan Rahman (Father)', 'blood_group' => 'O+', 'address' => "Chakaria, Cox's Bazar", 'admission_date' => '2023-06-15', 'role' => 'student', 'status' => 'active']);
