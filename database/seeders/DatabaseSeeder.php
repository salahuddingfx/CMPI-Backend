...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $fatima = User::create(['name' => 'Fatima Khatun', 'email' => 'fatima.civil@cmpi.edu.bd', 'password' => Hash::make('fatima123'), 'department' => 'Civil Technology', 'student_id' => 'CT-64 2319', 'semester' => '4th', 'session' => '2023-2024', 'phone' => '+880 1XXX-XXXXXX', 'guardian' => 'Abdul Kader (Father)', 'blood_group' => 'B+', 'address' => "Teknaf, Cox's Bazar", 'admission_date' => '2023-06-15', 'role' => 'student', 'status' => 'active']);
