...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name','email','password','department','student_id','board_roll','reg_no','semester','session','phone','guardian','blood_group','address','admission_date','avatar'];
    protected $guarded = ['role', 'sub_role', 'status'];
